...
// Add-begin by ning.wei@hmd for show who request the gpio for debug
#include <linux/gpio/consumer.h>
#include "../../gpio/gpiolib.h"
// Add-end by ning.wei@hmd for show who request the gpio for debug
				  ...
				  unsigned gpio)
{
	...
	struct gpio_desc *desc = gpio_to_desc(gpio); // ning.wei@hmd++ for debug
