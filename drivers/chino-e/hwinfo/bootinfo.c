...
/*add TP gesture begin,luxi,2023/10/27*/
int gesture_mode = 0;
EXPORT_SYMBOL(gesture_mode);
/*add TP gesture end,luxi,2023/10/27*/
...
CREATE_DEVICE_INFO(slave_charger_info);
...
{ 
        /* req SEAH-793 zhanghaozhuo 2023/10/14 begin */
	unsigned int cd_gpios =486;
        /* req SEAH-793 zhanghaozhuo 2023/10/14 end */
	int pin_val = 0;
...
static struct attribute * g[] = {
	...
	CREATE_DEVICE_ATTR(slave_charger_info),
