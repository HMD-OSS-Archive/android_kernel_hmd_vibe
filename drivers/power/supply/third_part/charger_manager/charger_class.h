...
enum charger_class_notifier_events {
	CHGCLS_EVENT_PROP_CHANGED,
};
...
struct charger_ops {
	...
	/* device init */
	int (*init)(struct charger_device *dev);
	...
	int (*ignore_chg_type_det)(struct charger_device *dev, bool en);

	/* hvdcp control */
	int (*enable_hvdcp_voltage)(struct charger_device *dev, u32 uV);
...
void charger_device_unregister(
	struct charger_device *charger_dev);

int charger_class_unreg_notifier(struct notifier_block *nb);
int charger_class_reg_notifier(struct notifier_block *nb);

struct charger_device *get_charger_by_name(
	const char *name);
...
int charger_dev_set_charging_current(
	struct charger_device *charger_dev, u32 uA);
int charger_dev_get_charging_current(
	struct charger_device *charger_dev, u32 *uA);
int charger_dev_get_min_charging_current(
	struct charger_device *charger_dev, u32 *uA);
int charger_dev_set_input_current(
	struct charger_device *charger_dev, u32 uA);
int charger_dev_get_input_current(
	struct charger_device *charger_dev, u32 *uA);
int charger_dev_get_min_input_current(
	struct charger_device *charger_dev, u32 *uA);
int charger_dev_set_eoc_current(
	struct charger_device *charger_dev, u32 uA);
int charger_dev_get_eoc_current(
	struct charger_device *charger_dev, u32 *uA);
int charger_dev_kick_wdt(
	struct charger_device *charger_dev);
int charger_dev_set_constant_voltage(
	struct charger_device *charger_dev, u32 uV);
int charger_dev_get_constant_voltage(
	struct charger_device *charger_dev, u32 *uV);
int charger_dev_dump_registers(
	struct charger_device *charger_dev);
int charger_dev_enable_vbus_ovp(
	struct charger_device *charger_dev, bool en);
int charger_dev_set_mivr(
	struct charger_device *charger_dev, u32 uV);
int charger_dev_get_mivr(
	struct charger_device *charger_dev, u32 *uV);
int charger_dev_get_mivr_state(
	struct charger_device *charger_dev, bool *in_loop);
int charger_dev_do_event(
	struct charger_device *charger_dev, u32 event, u32 args);
int charger_dev_is_powerpath_enabled(
	struct charger_device *charger_dev, bool *en);
int charger_dev_is_safety_timer_enabled(
	struct charger_device *charger_dev, bool *en);
int charger_dev_enable_termination(
	struct charger_device *charger_dev, bool en);
int charger_dev_is_charging_done(
	struct charger_device *charger_dev, bool *done);
int charger_dev_enable_powerpath(
	struct charger_device *charger_dev, bool en);
int charger_dev_enable_safety_timer(
	struct charger_device *charger_dev, bool en);
int charger_dev_ignore_chg_type_det(
	struct charger_device *charger_dev, bool en);
int charger_dev_enable_chg_type_det(
	struct charger_device *charger_dev, bool en);
int charger_dev_enable_hvdcp_det(
	struct charger_device *charger_dev, bool en);
int charger_dev_enable_hvdcp_voltage(
	struct charger_device *charger_dev, u32 uV);
int charger_dev_enable_otg(
	struct charger_device *charger_dev, bool en);
int charger_dev_enable_discharge(
	struct charger_device *charger_dev, bool en);
int charger_dev_set_boost_current_limit(
	struct charger_device *charger_dev, u32 uA);
int charger_dev_get_zcv(
	struct charger_device *charger_dev, u32 *uV);
int charger_dev_run_aicl(
	struct charger_device *charger_dev, u32 *uA);
int charger_dev_reset_eoc_state(
	struct charger_device *charger_dev);
int charger_dev_safety_check(
	struct charger_device *charger_dev, u32 polling_ieoc);
int charger_dev_enable_hz(
	struct charger_device *charger_dev, bool en);

/* PE+/PE+2.0 */
int charger_dev_send_ta_current_pattern(
	struct charger_device *charger_dev, bool is_increase);
int charger_dev_send_ta20_current_pattern(
	struct charger_device *charger_dev, u32 uV);
int charger_dev_reset_ta(
	struct charger_device *charger_dev);
int charger_dev_set_pe20_efficiency_table(
	struct charger_device *charger_dev);
int charger_dev_enable_cable_drop_comp(
	struct charger_device *charger_dev, bool en);

/* PE 3.0 */
int charger_dev_enable_chip(
	struct charger_device *charger_dev, bool en);
int charger_dev_is_chip_enabled(
	struct charger_device *charger_dev, bool *en);
int charger_dev_enable_direct_charging(
	struct charger_device *charger_dev, bool en);
int charger_dev_kick_direct_charging_wdt(
	struct charger_device *charger_dev);
...
int charger_dev_get_vbus(
	struct charger_device *charger_dev, u32 *vbus);
int charger_dev_get_ibus(
	struct charger_device *charger_dev, u32 *ibus);
int charger_dev_get_ibat(
	struct charger_device *charger_dev, u32 *ibat);
int charger_dev_get_temperature(
	struct charger_device *charger_dev, int *tchg_min,
		int *tchg_max);
int charger_dev_set_direct_charging_ibusoc(
	struct charger_device *charger_dev, u32 ua);
int charger_dev_set_direct_charging_vbusov(
	struct charger_device *charger_dev, u32 uv);
int charger_dev_set_direct_charging_ibatoc(
	struct charger_device *charger_dev, u32 ua);
int charger_dev_set_direct_charging_vbatov(
	struct charger_device *charger_dev, u32 uv);
int charger_dev_set_direct_charging_vbatov_alarm(
	struct charger_device *charger_dev, u32 uv);
int charger_dev_reset_direct_charging_vbatov_alarm(
	struct charger_device *charger_dev);
int charger_dev_set_direct_charging_vbusov_alarm(
	struct charger_device *charger_dev, u32 uv);
...
int charger_dev_init_direct_charging_chip(
	struct charger_device *charger_dev);

/* TypeC */
int charger_dev_enable_usbid(struct charger_device *dev, bool en);
int charger_dev_set_usbid_rup(struct charger_device *dev, u32 rup);
int charger_dev_set_usbid_src_ton(struct charger_device *dev,
					 u32 src_ton);
int charger_dev_enable_usbid_floating(struct charger_device *dev,
					     bool en);
int charger_dev_enable_force_typec_otp(struct charger_device *dev,
					      bool en);
int charger_dev_get_ctd_dischg_status(struct charger_device *dev,
					     u8 *status);

int charger_dev_enable_bleed_discharge(struct charger_device *dev,
					      bool en);

/* For buck1 FPWM */
int charger_dev_enable_hidden_mode(struct charger_device *dev, bool en);

int register_charger_device_notifier(
	struct charger_device *charger_dev,
			      struct notifier_block *nb);
int unregister_charger_device_notifier(
	struct charger_device *charger_dev,
				struct notifier_block *nb);
int charger_dev_notify(
