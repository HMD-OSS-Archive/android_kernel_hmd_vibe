...
/*bug APOLLO-49,bin,20220323,add,begin */
#define PSY_IIO_CHARGE_CONTROL_LIMIT		0x90
#define PSY_IIO_CHARGE_CONTROL_LIMIT_MAX	0x91
/*bug APOLLO-49,bin,20220323,add,end*/
